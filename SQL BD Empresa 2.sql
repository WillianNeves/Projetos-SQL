...
Select nome, idfuncionario, departamento
from funcionarios
where nome = 'Armstrong';


/* Traga os funcionarios que trabalhem no departamento de filmes 
OU no departamento de roupas */

Select Nome, Departamento, Cargo, idFuncionario
From funcionarios
...
/* Traga os funcionarios do sexo masculino ou os 
  funcionarios que trabalhem no setor Jardim */
  ...
  /* Trazer funcionários do departamento de games em ordem alfabética */
Select Nome, Sexo, Departamento, Cargo
from funcionarios
where departamento = 'Games'
order by Nome;


/* Contar a quantidade de funcionários por departamento */

Select count(departamento) as "Qtd", departamento
from funcionarios
group by departamento;


/* Trazer Nome e sexo dos funcionários do departamento de filmes */
Select Nome, Sexo, Departamento 
from funcionarios
where departamento = 'filmes';


/*Trazer o nome e email de todos os funcionarios dos departamentos de computadores e esporte e depois contar 
para tirar a prova real, quantos funcionários há nesses 2 departamentos */

Select Nome, email, Departamento
from funcionarios
where departamento ='Computadores' or departamento ='Esporte'
order by Departamento;
...
select count(*), Departamento
from funcionarios
where departamento = 'Esporte';



/* Trazer o nome e email de todos os funcionários dos departamentos de computadores e esporte do sexo feminino*/

Select Nome, Email, Sexo
from funcionarios
where departamento = 'Computadores' and sexo ='Feminino' 
or
departamento = 'Esporte' and sexo ='Feminino';


/* Contar a quantidade de departamentos  */

Select Count(distinct(departamento)) as Qtd_departamento
from funcionarios;



/* Contar a quantidade de funcionários do departamentos "industrial" */
...
/* Somar o salário de todos os funcionários de um departamento */

Select Sum(salario)
from funcionarios
where departamento = "Automotivo";
